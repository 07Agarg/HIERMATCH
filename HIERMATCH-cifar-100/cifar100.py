...
def train_val_split(labels, n_labeled, num_classes):
    ...
    for i in range(num_classes):
        ...
        num_labeled_per_class = n_labeled // num_classes
        train_labeled_idxs.extend(idxs[:num_labeled_per_class])
        train_unlabeled_idxs.extend(idxs[num_labeled_per_class:-50])
